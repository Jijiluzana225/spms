...
urlpatterns = [
    ...
    path('employees/<int:pk>/edit/', employee_update, name='employee_edit'),
    path('employees/<int:pk>/delete/', employee_delete, name='employee_delete'),
    
    path('my-profile/', user_profile, name='user_profile'),
    path('add-user-employee/', views.create_user_with_employee, name='add_user_employee'),
