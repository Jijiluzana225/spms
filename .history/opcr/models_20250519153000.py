...
class OPCR(models.Model):
    division = models.ManyToManyField(Division, on_delete=models.CASCADE)
    name = models.CharField(max_length=255,default="OPCR")
    year = models.PositiveIntegerField()
    status = models.CharField(max_length=20, choices=STATUS_CHOICES, default='Proposed')
...
class OPCR_Smart_kpi(models.Model):
    ...
    first_half_percent = models.DecimalField(max_digits=10, decimal_places=2,null=True, blank=True)
    first_half_unit = models.DecimalField(max_digits=10, decimal_places=2,null=True, blank=True)
    second_half_percent = models.DecimalField(max_digits=10, decimal_places=2,null=True, blank=True)
    second_half_unit = models.DecimalField(max_digits=10, decimal_places=2,null=True, blank=True)
    ...
    accomplishment_qty= models.DecimalField(max_digits=10, decimal_places=2,null=True, blank=True)
    accomplishment_percent = models.DecimalField(max_digits=10, decimal_places=2,null=True, blank=True)

    evidence_file = models.ImageField(upload_to='evidence/', null=True, blank=True)
    quality = models.DecimalField(max_digits=10, decimal_places=2,null=True, blank=True)
    efficiency = models.DecimalField(max_digits=10, decimal_places=2,null=True, blank=True)
    timeliness = models.DecimalField(max_digits=10, decimal_places=2,null=True, blank=True)
    averagescore = models.DecimalField(max_digits=10, decimal_places=2,null=True, blank=True)
    
    score = models.DecimalField(max_digits=10, decimal_places=2,null=True, blank=True)
    remarks = models.TextField(null=True, blank=True)  # Activity field with max length 250 characters
